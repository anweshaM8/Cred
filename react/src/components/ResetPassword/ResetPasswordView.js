...
const ResetPasswordView = ({ formSubmitData }) => {
    const { register, handleSubmit, errors, getValues } = useForm();
    return (

        <div className="list-details">
            <Breadcrumb pageTitleIcon={faUnlock} pageTitle="Reset Password" />
            <MetaTagsView title="Reset Password" />
            <div className="row">
                    ...
                    <div className="form-ui-wrapper white-panel">
                        ...
                        <form className="form-style" onSubmit={handleSubmit(formSubmitData)}>
                            ...
                            <div className="mt-4 d-flex align-items-center btn__back__to-hld">
                                <Link className="ml-auto btn btn-outline-success mr-4" to="/"><FontAwesomeIcon className="mr-1" icon={faChevronLeft} /> Back</Link>
